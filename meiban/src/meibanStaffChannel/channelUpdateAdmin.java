...
public class channelUpdateAdmin {
    ...
    @Test
    public void channelUpdateAdmin1() //����Աת����������
    {
    ...
    @Test
    public void channelUpdateAdmin2() //�ǹ���Աת��
    {
        String host = Host.getURL();
        String url = host + "/v1/channel/updateAdmin?id=266018d7-d743-4eba-bf06-3f0056dd7ef7&adminId=7260";
        String token = "7d61c49d-4935-4cd9-801a-a4b9fddb53db";
    ...
    @Test
    public void channelUpdateAdmin3() //Ƶ��ID������
    {
        String host = Host.getURL();
    ...
    @Test
    public void channelUpdateAdmin4() //adminId������
    {
        String host = Host.getURL();
    ...
    @Test
    public void channelUpdateAdmin5() //adminIdΪnull
    {
        String host = Host.getURL();
